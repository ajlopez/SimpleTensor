...
exports['identity number'] = function (test) {
	var number = st.constant(42);
	
	var oper = st.identity(number);
...
exports['identity vector'] = function (test) {
	var value = st.constant([ 1, 2, 3 ]);
	
	var oper = st.identity(value);
...
exports['identity matrix'] = function (test) {
	var value = st.constant([ [ 1, 2, 3 ], [ 1, 2, 3 ] ]);
