...
function createCosOperation(node) {
	return new GenericUnaryOperation(node, function (x) { return Math.cos(x); });
}

function createSinOperation(node) {
	return new GenericUnaryOperation(node, function (x) { return Math.sin(x); });
}

function createACosOperation(node) {
	return new GenericUnaryOperation(node, function (x) { return Math.acos(x); });
}

function createASinOperation(node) {
	return new GenericUnaryOperation(node, function (x) { return Math.asin(x); });
}
